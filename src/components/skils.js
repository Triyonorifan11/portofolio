        ...
        <div className="relative bg-primary">
            ...
            <div className="flex flex-wrap">
                <div className="w-full lg:w-[40%] mt-32 lg:pl-24 lg:text-left text-center">
                    <h1 className="block font-bold text-white text-4xl pt-2 lg:text-5xl mb-2 font-gothamBlack">I'm a Junior Front-End Web Developer</h1>
                    <div className="py-10 leading-3">
